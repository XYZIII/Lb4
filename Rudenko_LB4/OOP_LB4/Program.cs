...
namespace OOP_LB4_1_3_task
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Human human = new Human("Vadim", "Poroshenko", "Male", 38);
            Debug.WriteLine($"This is class {human.GetType().Name}");
            human.Info();

            Employee employee = new Employee("Vadym", "Rudenko", "Male", 19, "Director", 18325);
            ...
            Unit unit = new Unit("Cat", "Fire");
            unit.ShowInfo();

            Hero hero = new Hero("Sam", "Cow", 1200, "Bowl", 15);
            hero.ShowInfo();

            Enemy enemy = new Enemy("Mouse", "Cave", 20000, "Cheese", 30);
            enemy.ShowInfo();
